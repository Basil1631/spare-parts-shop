<x-layouts.app title="Record purchase">
    <h1 class="text-2xl font-semibold mb-4">Purchase spare parts</h1>
    <p class="text-sm text-slate-500 mb-4">Scan or photograph the supplier invoice (phone camera works). Print bills from the browser print dialog or PDF.</p>
