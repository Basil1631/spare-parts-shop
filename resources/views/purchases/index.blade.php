<x-layouts.app title="Purchases">
    <div class="flex justify-between mb-4">
        ...
        <a href="{{ route('purchases.create') }}" class="bg-slate-900 text-white px-4 py-2 rounded-md">Raise purchase</a>
    </div>
    <table class="w-full text-sm bg-white rounded-lg">
        <thead class="bg-slate-50 text-left"><tr><th class="px-3 py-2">Date</th><th>Branch</th><th>Supplier</th><th>Invoice</th><th>Status</th><th>Total</th><th></th></tr></thead>
        <tbody>
